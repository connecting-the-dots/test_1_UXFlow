        ...
        public boolean onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
          ...
          if (drawerItem != null) {
            ...
            if (drawerItem.getIdentifier() == 0) {
              ...
              intent = new Intent(ProfileActivity.this, FocusActivity.class);
            } else if (drawerItem.getIdentifier() == 2) {
              intent = new Intent(ProfileActivity.this, KickActivity.class);
            } else if (drawerItem.getIdentifier() == 3) {
              intent = new Intent(ProfileActivity.this, TimelineActivity.class);
            } else if (drawerItem.getIdentifier() == 4) {
              intent = new Intent(ProfileActivity.this, OverviewActivity.class);

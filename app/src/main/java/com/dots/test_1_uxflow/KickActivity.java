        ...
        public boolean onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
          ...
          if (drawerItem != null) {
            ...
            if (drawerItem.getIdentifier() == 0) {
              intent = new Intent(KickActivity.this, DashboardActivity.class);
            } else if (drawerItem.getIdentifier() == 1) {
              intent = new Intent(KickActivity.this, FocusActivity.class);
            } else if (drawerItem.getIdentifier() == 2) {
//              intent = new Intent(KickActivity.this, KickActivity.class);
            } else if (drawerItem.getIdentifier() == 3) {
              intent = new Intent(KickActivity.this, TimelineActivity.class);
            } else if (drawerItem.getIdentifier() == 4) {
              intent = new Intent(KickActivity.this, OverviewActivity.class);
            } else if (drawerItem.getIdentifier() == 5) {
              intent = new Intent(KickActivity.this, ProfileActivity.class);
...
//              intent = new Intent(DashboardActivity.this, MainActivity.class);
              ...
              intent = new LibsBuilder()
                ...
                .intent(KickActivity.this);
            }
            if (intent != null) {
              KickActivity.this.startActivity(intent);
            }
          }
  ...
  public void onBackPressed() {
    ...
    if (MainApplication.result != null && MainApplication.result.isDrawerOpen()) {
      ...
      Intent intent = new Intent(KickActivity.this, DashboardActivity.class);
      KickActivity.this.startActivity(intent);
    }
  }
}
